...
// Move configuration outside the component to prevent unnecessary re-definitions
const navItemsConfig = [
    { name: 'Overview', icon: LayoutDashboard, pathSuffix: '' },
    { name: 'Admin Center', icon: Zap, pathSuffix: '/active' },
    { name: 'Volunteers', icon: Users, pathSuffix: '/volunteers' },
    { name: 'Shifts', icon: Calendar, pathSuffix: '/shifts' },
    { name: 'Assets', icon: Package, pathSuffix: '/assets' },
    { name: 'Assignments', icon: Zap, pathSuffix: '/assign' },
    { name: 'Check-in', icon: UserCheck, pathSuffix: '/checkin' },
    { name: 'Reports', icon: FileBarChart, pathSuffix: '/reports' },
    { name: 'Audit Log', icon: ClipboardList, pathSuffix: '/audit' },
    { name: 'Settings', icon: Settings, pathSuffix: '/share' },
]
            ...
            <div className="h-full w-full overflow-y-auto overflow-x-hidden p-4 flex flex-col gap-8">
                ...
                <nav className="flex flex-col gap-2">
                    {navItemsConfig.map((item) => {
                        const href = `/events/${id}${item.pathSuffix}`
